...
apt-get update && \
apt-get upgrade -y && \
BUILD_PACKAGES="supervisor nginx php5.6-fpm git php5-mysql php5-curl php5-gd php5-intl php5-mcrypt php5-memcache php5-sqlite php5-tidy php5-xmlrpc php5-xsl php5-pgsql php5-mongo php5-ldap pwgen" && \
